package com.sdu.wh.ui.warehouse;
...
import com.sdu.wh.bll.WarehouseDepartmentBLL;
 ...
 *
 */
public class ConfirmIn extends JInternalFrame {

	private WarehouseDepartmentBLL mWarehouseDepartmentBLL = new WarehouseDepartmentBLL();
	...
	public ConfirmIn() {
		...
		//查询生成表
		mTable=new JTable();
		mWarehouseDepartmentBLL.refreashProduceTable(mTable);
		initialTable(mTable);
