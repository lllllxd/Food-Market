...
import com.sdu.wh.bll.FinanceDepartmentBLL;
 ...
 *
 */
public class Gathering extends JInternalFrame {

	private FinanceDepartmentBLL mFinanceDepartmentBLL = new FinanceDepartmentBLL();
	
	private JTable mTable;
	
	public Gathering() throws Exception {
		...
		//查询生成表
		mTable=new JTable();
		mFinanceDepartmentBLL.refreshFinanceTable(mTable);
		initialTable(mTable);
